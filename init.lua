...
require('lazy').setup({
  {
    -- config for easy file navigation
    'stevearc/oil.nvim',
    opts = {},
    dependencies = {
  ...
  'Hoffs/omnisharp-extended-lsp.nvim', -- allows decompilation of .NET system libraries
  'mg979/vim-visual-multi',
  --{ "jay-babu/mason-null-ls.nvim", opt = {} },
  --{ "jose-elias-alvarez/null-ls.nvim", opt = {} },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --
          -- replacing telescope with omnisharp_extended version
      ...
      local servers = {
        ...
        pyright = {},
        omnisharp = {
          cmd = { 'dotnet', 'R:\\_tooling\\omnisharp-win-x64-net6.0\\OmniSharp.dll' },
          settings = {
